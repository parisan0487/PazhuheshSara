...
export default function Navbar() {
    ...
    return (
        <div
                ...
                <div className="flex justify-between gap-4 items-center text-right ">
                    ...
                    <nav className="flex gap-8">
                        <div className="flex items-center gap-2 z-10">
                            <Link href="/">
                                <Image src="/img/logo.jpg" alt="لوگو" width={70} height={70}  className="rounded-full"/>
                            </Link>
                        </div>
                            ...
                            {navLinks.map((item) => {
                                ...
                                return (
                                    <li key={item.href} className="relative group">
                                        <Link
                                            href={item.href}
                                            className={`flex items-center gap-1 relative font-bold transition-colors duration-500 hover:text-[#00e0ca] ${isActive ? "text-[#00e0ca]" : "text-black"
                                                }`} // تغییر رنگ متن
                                        >
                                            {item.label}
                    ...
                    <div className="flex gap-5 max-[1067px]:hidden">
                        <div className="flex gap-2 mt-3">
                            ...
                            <span className="text-black text-[1.1rem] font-bold z-10 transition-colors duration-500 hover:text-[#73ED7C]">
                                09304898743
                            </span>
                        </div>
          ...
          flex items-center justify-center text-center font-bold text-black
          focus:outline-none"
                            >
                                <span
