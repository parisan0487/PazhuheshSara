    ...
    const handleDelete = async (id, jDate) => {
        toast((t) => (
            <div className="text-center">
                <p className="font-semibold mb-3 text-gray-800">آیا از حذف تعطیلی مطمئن هستید؟</p>
        ...
        <div className="p-8 rounded-3xl shadow-2xl max-w-3xl mx-auto">
            ...
            <form onSubmit={handleAdd} className="flex flex-col sm:flex-row gap-4 mb-8">
                <input
                    ...
                    className="border border-green-300 p-3 rounded-xl w-full sm:w-64 focus:outline-none focus:ring-2 focus:ring-[#00e0ca] transition-all shadow-sm"
                />
                <button className="bg-[#00e0ca] text-white px-5 py-2 rounded-xl hover:bg-green-700 shadow-md transition transform hover:-translate-y-1">
                    افزودن
                </button>
            </form>
